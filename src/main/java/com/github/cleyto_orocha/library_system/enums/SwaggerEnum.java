...
public class SwaggerEnum {
    ...
    public static final String ADDRESS_TAG_NAME = "3 - Address";
    public static final String PRODUCT_TAG_NAME = "4 - Product";
    public static final String ACQUISITION_TAG_NAME = "5 - Acquisition";
    ...
    public static final String ADDRESS_TAG_DESCRIPTION = "Address operations by the client";
